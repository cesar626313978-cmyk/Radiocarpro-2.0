          ...
          {user ? (
            ...
            <div className="flex items-center gap-1 sm:gap-1.5">
              ...
              >
                ...
                <span className="hidden min-[1300px]:inline">Acceder con Gmail</span>
                <span className="hidden sm:inline min-[1300px]:hidden">Gmail</span>
              </button>
              ...
              {onOpenTeslaPairing && (
                ...
                >
                  ...
                  <span className="hidden min-[1300px]:inline">Vincular Tesla (QR)</span>
                  <span className="hidden md:inline min-[1300px]:hidden">Tesla QR</span>
                </button>
              )}
            </div>
          )}
